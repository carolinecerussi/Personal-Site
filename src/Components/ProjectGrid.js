              ...
              <div className="portfolio__box"><div className="portfolio__group">
                ...
                <div className="portfolio__text-section">
                  ...
                  <h1 className="portfolio__title hover-underline-animation">
                    <a href="https://github.com/carolinecerussi/Personal-Site" className="portfolio__link">Personal Website →</a></h1>
            ...
            <div className="portfolio__content">
              <div className="portfolio__box"><div className="portfolio__group">
                ...
                <div className="portfolio__text-section">
                  ...
                  <h1 className="portfolio__title hover-underline-animation">
                    <a href="https://www.loom.com/share/f47dc27da3d94811992b5e7cd3d7eaaf?sid=8c0180b6-d61f-4216-8a81-18d30e3b4d72" className="portfolio__link">Robot Translator →</a></h1>
